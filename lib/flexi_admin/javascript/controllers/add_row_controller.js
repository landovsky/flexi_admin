...
export default class extends Controller {
  ...
  add(event) {
    ...
    // Get only direct children matching the template selector
    const templates = Array.from(container.children).filter(child =>
    ...
    const lastTemplate = templates[templates.length - 2]
